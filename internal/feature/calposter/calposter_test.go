...
func TestBuildMonthlyNeedsHistory(t *testing.T) {
	...
	// 灾变防线：两期各 25 天、首尾相接但都不在 1 日 —— 判据 b。
	...
	recs := []annsync.Rec{
		...
		actRec("b-0", "灾变防线", "2026-08-18 04:00", "2026-09-12 03:59"),
		actRec("b-1", "灾变防线", "2026-09-12 04:00", "2026-10-07 03:59"),
	...
	if strings.Join(monthly, ",") != "灾变防线,联合讨伐" {
